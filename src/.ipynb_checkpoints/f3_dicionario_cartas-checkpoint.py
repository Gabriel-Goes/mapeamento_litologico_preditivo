...
from src.f1_importar_geometrias import import_malha_cartog
...
def regions(malha_cartog):
    ...
    malha_cartog.to_crs("EPSG:32724",inplace=True)   # APENAS AS INFORMAÇOES NA ZONA 23SUL UTM ESTARÃO CORRETAS
...
# LISTANDO REGIOES DE CADA FOLHA DE CARTAS DA MALHA CARTOGRAFICA \ ['REGEION'] = ['ID_FOLHA'] REDUNDANCIA
