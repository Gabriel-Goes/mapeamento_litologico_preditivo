...
cp -p -r iagtese.cls iagtese_en.cls bibliografia.sty bibliografia_en.sty fancyhdr.sty fncychap.sty deluxetable.sty longtable.dtx $pathcls
cp -p -r iag.bst iag_en.bst $pathbib
cp -p -r caption.sty caption3.sty $pathcap
texhash
